...
{                                                                              }
{  This template provides the minimum project file needed to create a C/C++    }
{  project using the Ultibo API.                                               }
{                                                                              }
{  The template simply calls a "main" function in the C/C++ project and passes }
