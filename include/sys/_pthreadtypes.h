...
#else /* !defined(__XMK__) */
#if defined(ULTIBO)
typedef unsigned long pthread_mutex_t;   /* identify a mutex */
#else /* !defined(ULTIBO) */
...
#if defined(ULTIBO)
typedef unsigned long pthread_cond_t;    /* identify a condition variable */
#else /* !defined(ULTIBO) */
...
#if defined(ULTIBO)
typedef unsigned long pthread_key_t;     /* thread-specific data keys */
#else /* !defined(ULTIBO) */
...
#if defined(ULTIBO)
typedef unsigned long pthread_barrier_t;     /* POSIX Barrier Object */
#else /* !defined(ULTIBO) */
...
#if defined(ULTIBO)
typedef unsigned long pthread_spinlock_t;     /* POSIX Spin Lock Object */
#else /* !defined(ULTIBO) */
...
#if defined(ULTIBO)
typedef unsigned long pthread_rwlock_t;      /* POSIX RWLock Object */
#else /* !defined(ULTIBO) */
